...
| [SimpleHelp Authentication Bypass Exploitation](simplehelp_auth_bypass_exploitation.md) | T1190, T1219 | CVE-2026-48558 auth bypass enabling unauthenticated access to SimpleHelp admin/API endpoints; Java process spawning OS interpreters post-exploitation |
| [SharePoint Server Deserialization RCE Exploitation](sharepoint_deserialization_rce_exploitation.md) | T1190, T1505.003 | CVE-2026-45659 deserialization RCE via crafted SOAP/ViewState payloads; w3wp.exe spawning OS interpreters, ASPX web shell drops to SharePoint directories |
...
| Scattered Spider (UNC3944) / Ransomware Affiliates | Cybercrime | Exploit RMM and remote support tool auth bypasses (CVE-2026-48558) to gain unauthorized remote access as initial foothold before ransomware staging | [MITRE ATT&CK - T1219](https://attack.mitre.org/techniques/T1219/) |
| China-Nexus APT Groups (HAFNIUM, UNC4841) | Nation-State APT | SharePoint deserialization exploitation (CVE-2026-45659) continues HAFNIUM/ProxyShell playbook for persistent enterprise access; ASPX web shell deployment for durable foothold | [MITRE ATT&CK - T1190](https://attack.mitre.org/techniques/T1190/), [MITRE ATT&CK - HAFNIUM (G0125)](https://attack.mitre.org/groups/G0125/) |
